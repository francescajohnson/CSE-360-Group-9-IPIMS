...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->checkBoxNewUser->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->checkBoxNewUser->Location = System::Drawing::Point(208, 234);
			this->checkBoxNewUser->Name = L"checkBoxNewUser";
			this->checkBoxNewUser->Size = System::Drawing::Size(205, 30);
...
#pragma endregion
	private: System::Void buttonContinue_Click(System::Object^  sender, System::EventArgs^  e) {
		if (checkBoxNewUser->Checked)
		{
			...
			IPIMS_Group_9::Registration^ formRegistration = gcnew Registration();
			this->Hide();
			...
			this->Hide();
			IPIMS_Group_9::Welcome^ formWelcome = gcnew Welcome();
